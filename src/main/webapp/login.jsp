...
<head>
    ...
    <title>Iniciar Sesión - BAKETRAK</title>
...
<body>
    ...
    <!-- Vista Login -->
    <section id="login-view" class="container mt-5">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card p-4 shadow">
                    ...
                    <div class="text-center mt-3">
                        <a href="#" class="text-primary" onclick="alert('Función de recuperación de contraseña en desarrollo')">¿Olvidaste tu contraseña?</a>
                        <br>
                        <a href="register.jsp" class="text-primary">Crear una cuenta</a>
                    </div>
                </div>
            </div>
        </div>
